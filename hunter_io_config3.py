#!/usr/bin/env python3
"""
Hunter.io API Client Configuration - Third API Key
"""
...
class HunterIOClient3:
    """Hunter.io API Client for third API key"""
...
# Create client with third API key
hunter_client3 = HunterIOClient3("601920a0b5d6b80f9131d4ae588065f694840081")