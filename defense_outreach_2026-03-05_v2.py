#!/usr/bin/env python3
"""Defense Sector Outreach - 2026-03-05 (using sam@impactquadrant.info)"""
...
# First, let's check what inboxes are available
try:
...
print("\n=== Sending Defense Company Outreach ===")
...
sam@impactquadrant.info"""
    ...
    try:
        # Try using sam@impactquadrant.info as the inbox
