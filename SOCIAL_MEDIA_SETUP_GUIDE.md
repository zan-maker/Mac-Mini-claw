# 🚀 SOCIAL MEDIA OUTREACH SETUP GUIDE
...
cat /Users/cubiczan/.openclaw/workspace/social_media_outreach/content_calendar_*.json |   jq '.[] | select(.date == "'$(date +%Y-%m-%d)'") | {time, profile, topic}'
```
